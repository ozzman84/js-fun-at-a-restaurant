...
var stockCount = inStock >= 1 ? `I'm going to eat some ${food}!` : `We need to get some more ${food}.`
...
var statement = isFavorite ? `My favorite food is ${food}!` : `I recently ate ${food}`
...
var vegetables = ['spinach', 'cucumber', 'lettuce', 'tomato', 'corn']
...
var fruits = ['strawberry', 'kiwi', 'apple', 'banana', 'tangerine', 'pear', 'blueberry']
